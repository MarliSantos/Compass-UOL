''' Ex 13- Implemente a função my_map(list, f) que recebe uma lista como primeiro argumento e uma função como segundo argumento. 
...
outra_lista = my_map(lista, potencia_de_2)
print(outra_lista)